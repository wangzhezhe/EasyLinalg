#ifndef MATRIX_H_STATIC_THREE
#define MATRIX_H_STATIC_THREE
...
#define MSIZE 3
    ...
    inline bool invert3by3matrix(mat m, mat inv_m)
    {
        ...
        double det = m->v[0][0] * (m->v[1][1] * m->v[2][2] - m->v[1][2] * m->v[2][1]) - m->v[0][1] * (m->v[1][0] * m->v[2][2] - m->v[1][2] * m->v[2][0]) + m->v[0][2] * (m->v[1][0] * m->v[2][1] - m->v[1][1] * m->v[2][0]);
